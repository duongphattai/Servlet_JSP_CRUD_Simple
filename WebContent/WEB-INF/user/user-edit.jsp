...
<body>
    <div class="container">
        ...
        <form action="<%= request.getContextPath() + UrlConst.USER_EDIT %>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" readonly name="username" value="${curUser.username }" id="" class="form-control" placeholder="" aria-describedby="helpId">
        </div>
        <div class="form-group">
